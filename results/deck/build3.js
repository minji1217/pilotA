...
[["USGS 값에 칸 수를 곱해야 한다","단위를 맞추니 0.797 → 0.840 으로 올랐다. 학습을 하나도 안 하고, 엑셀 열 두 개를 곱해서.",ACC],
...
/* ─────────── 5 발견 ① 면적 항 ─────────── */
s=pres.addSlide(); s.background={color:WHT};
T(s,"발견 ① USGS 값은 확률이 아니라 면적 비율이다","“격자 한 칸에서 산사태가 덮는 면적의 비율”이고, 우리가 맞히려는 것과 단위가 다르다");
